                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li class="active"><a href="user.jsp" class="active"><i class="lnr lnr-users"></i> <span>Show Users</span></a></li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Show User Details</h3>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            String sql = "Select * from tbl_users where utype='user'";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit.jsp?id=<%=rs.getString("email")%>" onclick="return confirm('If you want change status this user ?');"><i class="fa  fa-pencil-square" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <%
                                                i++;
                                            }%>
