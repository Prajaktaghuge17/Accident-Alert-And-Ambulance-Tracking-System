                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li class="active"><a href="hospitals.jsp" class="active"><i class="lnr lnr-apartment"></i> <span>Hospitals</span></a></li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Show Hospital Details</h3>
                                <!--<a href="add_hospital.jsp" class="btn- pull-right">Add Hospital</a>-->
                                <a href="#" class="btn btn-primary btn-sm active pull-right" role="button" aria-pressed="true" data-toggle="modal" data-target="#exampleModal">Add Hospital</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            String sql = "Select * from tbl_users where utype='hospital'";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Hospital</h5>
                            ...
                            <form action="AddHospital" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-form-label">Hospital Name:</label>
                                        <input type="text" class="form-control" id="name" name="name">
                                    </div>
                                    <div class="form-group">
                                        <label for="email" class="col-form-label">Hospital Email:</label>
                                        <input type="email" class="form-control" id="email" name="email">
                                    </div>
                                    <div class="form-group">
                                        <label for="mobile" class="col-form-label">Hospital Mobile:</label>
